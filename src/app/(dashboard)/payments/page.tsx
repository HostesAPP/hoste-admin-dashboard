...
import { CreditCard, DollarSign, Download, RefreshCw, Send, Lock, Search } from "lucide-react";
...
export default function PaymentsPage() {
  ...
  // PRD v2.2 §04 Total Service Fee calculation (Payment.ServiceFee = 10% Service Fee)
  const totalServiceFeeEarned = payments
  ...
  return (
    <PageHeaderLayout
      ...
      description="Track platform Service Fees (10%), Host Platform Fees (₦1,000), held escrow funds, and Paystack direct refunds (PRD v2.2)."
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card>
            <CardContent className="p-4 flex items-center justify-between">
              <div>
                <p className="text-xs text-muted-foreground font-medium">Service Fee Earned (10%)</p>
                <p className="text-2xl font-bold mt-1 text-emerald-600">
                  ₦{totalServiceFeeEarned.toLocaleString()}
                </p>
              </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/50">
                  ...
                  <TableHead className="text-xs">Host Flat Fee (₦1k)</TableHead>
                  <TableHead className="text-xs">Net Payout Amount</TableHead>
              ...
              <TableBody>
                {payouts.map((pyo) => (
                  <TableRow key={pyo.id}>
                    ...
                    <TableCell className="text-xs text-muted-foreground">₦{pyo.platformFlatFee.toLocaleString()}</TableCell>
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-2 bg-rose-500/10 border border-rose-500/20 rounded text-[11px] text-rose-800 dark:text-rose-200">
                  <strong>Rule (PRD v2.2):</strong> Destination is strictly locked to <code>Original Payment Method (Paystack)</code>. No internal wallet exists.
                </div>
