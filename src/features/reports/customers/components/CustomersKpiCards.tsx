...
import type { CustomerReportKpiMetric } from "../types/customers.types";

interface CustomersKpiCardsProps {
  metrics: CustomerReportKpiMetric[];
}

export const CustomersKpiCards: React.FC<CustomersKpiCardsProps> = ({ metrics }) => {
  return (
