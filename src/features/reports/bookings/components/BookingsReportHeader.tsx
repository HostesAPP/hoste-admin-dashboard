...
interface BookingsReportHeaderProps {
  dateRange: string;
...
export const BookingsReportHeader: React.FC<BookingsReportHeaderProps> = ({
  dateRange,
  onDateRangeChange,
  onExportClick,
}) => {
    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-2">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
          ...
          <span>/</span>
          <span className="text-primary font-semibold">Bookings</span>
        </div>
        ...
        <p className="text-xs sm:text-sm text-muted-foreground">
          Monitor booking activity, trends, and performance across Hosté
        </p>
      </div>
